 ...
 * @param <VO> 视图对象
 */
public interface QueryServiceApi <Entity extends BaseEntity,Long,Criteria,VO extends BaseView> extends BaseServiceApi {
     ...
     * @return
     */
    Predicate getPredicate(Criteria query);
    /**
     * 根据Id查询唯一实体
     * @param id
     * @return
