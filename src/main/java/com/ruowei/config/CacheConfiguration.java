...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ruowei.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ruowei.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.ruowei.domain.SysUser.class.getName());
